...
def build_signal_html(s):
    ...
    if s['crash_3_hit']:
        ...
        action_lines = [
            f"매수단가 ${s['cost_basis']} 대비 +{s['gain_pct']:.1f}% 달성 (목표 +{TRIGGER_PCT*100:.0f}%)",
        ...
        action_title = "보유 유지"
        action_lines = [
            f"매수단가 ${s['cost_basis']} 대비 현재 {s['gain_pct']:+.1f}%",
    ...
    <div style="background:white;padding:20px 24px;border-radius:0 0 10px 10px;
        ...
        <table style="width:100%;border-collapse:collapse;font-size:13px;margin-bottom:18px;">
            <tr style="border-bottom:1px solid #eee;">
                <td style="padding:8px;color:#888;">매수단가 (per-share CB)</td>
